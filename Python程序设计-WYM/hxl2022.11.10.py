...
with open(r'f:\大三上\大三上\Python程序设计\课堂笔记\2022.11.10文件操作1.txt','a') as f1,open(r'f:\大三上\大三上\Python程序设计\课堂笔记\2022.11.10文件操作2.txt','r') as f2:
    f1.write(f2.read())
...
writecsv1(r'F:\大三上\大三上\Python程序设计\课堂笔记\黄心灵scores.csv')
